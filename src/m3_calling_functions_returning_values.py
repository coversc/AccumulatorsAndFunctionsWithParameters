...
def run_test_sum_of_digits():
    ...
    # Test 3
    expected = 7
    answer = sum_of_digits(124)
    print('Test 3 expected', expected)
    print('        actual:  ', answer)

    # Test 4
    expected = 24
    answer = sum_of_digits(897)
    print('Test 4 expected', expected)
    print('        actual:  ', answer)

    # Test 5
    expected = 22
    answer = sum_of_digits(8932)
